...
In our research, we used an approach that is somewhere in between these two methods. Firstly, subset of pre-tagged tweets was created using an adapted hashtag-based analysis. This was then used in a K Nearest Neighbours algorithm, which classified tweets based on their vector r
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTU3ODU3MDksMjA0NzgwNDE2LC05OD
